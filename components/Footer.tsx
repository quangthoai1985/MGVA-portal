    ...
    <footer className="bg-slate-900 text-gray-300 py-16 text-sm relative" id="footer">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="leading-relaxed text-gray-400">
              Trường Mẫu Giáo Vàng Anh - Nơi ươm mầm những ước mơ con trẻ.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 group">
                ...
                <span className="group-hover:text-white transition-colors">123 Đường Hạnh Phúc, Quận 1, TP.HCM</span>
              </li>
              <li className="flex items-center gap-3 group">
                <Phone className="w-5 h-5 text-brand-500 shrink-0 group-hover:text-brand-400 transition-colors" />
                <span className="group-hover:text-white transition-colors">090 123 4567</span>
              </li>
              <li className="flex items-center gap-3 group">
                <Mail className="w-5 h-5 text-brand-500 shrink-0 group-hover:text-brand-400 transition-colors" />
                <span className="group-hover:text-white transition-colors">info@vanganh.edu.vn</span>
              </li>
              <li className="flex items-center gap-3 group">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">© 2024 Trường Mẫu Giáo Vàng Anh. Tất cả quyền được bảo lưu.</p>
