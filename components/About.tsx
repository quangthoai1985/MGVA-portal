        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              Được thành lập từ năm 2010, Trường {settings?.schoolName || 'Mẫu Giáo Vàng Anh'} tự hào là đơn vị tiên phong trong việc áp dụng phương pháp giáo dục sớm, kết hợp tinh hoa của Montessori và chương trình chuẩn của Bộ Giáo dục.
            </p>

            <p className="text-gray-600 leading-relaxed">
              Chúng tôi tin rằng mỗi đứa trẻ là một hạt giống duy nhất và đặc biệt. Nhiệm vụ của {settings?.schoolName || 'Vàng Anh'} là tạo ra môi trường đất màu mỡ, đầy đủ ánh sáng và tình yêu thương để hạt giống ấy nảy mầm và vươn cao mạnh mẽ.
            </p>
